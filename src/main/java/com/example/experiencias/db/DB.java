package com.example.experiencias.db;
...
public class DB {
	...
	public static void execute(Connection con, String sql, String titulo, String descripcion, double precio,
			String ubicacion, int duracion_horas, int categoria_id, Object activa) {
